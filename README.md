...
| Diagnostic | Value |
|---|---|
| Partial F-statistic | **5,994.9** |
| Partial R-squared | 0.0997 |
| Instrument coefficient | 0.966 (t = 77.4) |

The instrument is extremely strong (F >> 10), ruling out weak instrument concerns.

### Second Stage — IV Estimates

| Outcome | Coefficient on `number_issues` | T-stat | P-value |
|---|---|---|---|
| `amendment` (binary) | **+0.0138** | 25.0 | 0.000 |
| `number_amendments` (count) | **+0.0312** | 8.4 | 0.000 |
| `investigation` (binary) | **-0.0004** | -3.0 | 0.003 |
